  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                <NavLink to='/seller'className="px-4 py-1.5 bg-primary text-white rounded-full shadow-md hover:shadow-lg hover:bg-primary-dull">Seller Dashboard</NavLink>
            ...
            {/* Mobile Menu */}
            { open &&(
                <div className={`${open ? 'flex' : 'hidden'} absolute top-[60px] left-0 w-full z-10 bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden`}>
